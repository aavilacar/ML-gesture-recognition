...
The first few chapters of the 'TinyML' book by Pete Warden & Daniel Situnayake explain step by step how the 'train_hello_world_model.ipynb' code was built to create a ML model. The rest of the book shows additional ML examples of real-life applications and further ML practice.